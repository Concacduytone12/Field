...
local KillDoughKingHop = Tabs.stack:AddToggle("MyToggle", {Title = "Auto Kill Dough King Hop", Description = "" ,Default = _G.AutodoughkingHop })
...
spawn(function()
        while wait() do 
                            ...
                            if v.Name == "Terrorshark" then
                                if v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 then
                                    repeat task.wait()
                                        ...
                                        v.Humanoid.WalkSpeed = 0
                                        v.Head.CanCollide = false 
                                        TP2(v.HumanoidRootPart.CFrame * CFrame.new(5,40,10))
                                        MonFarm = v.Name                
                                        PosMon = v.HumanoidRootPart.CFrame
            game.Players.LocalPlayer.Character.Humanoid.Sit = false
                      ...
                      TP2(game:GetService("Workspace").Boats.PirateBrigade.VehicleSeat.CFrame * CFrame.new(0, -1, 0))		                       
                        for i,v in pairs(game:GetService("ReplicatedStorage"):GetChildren()) do                                 
                            if v.Name == "Terrorshark" then
                                TP2(v.HumanoidRootPart.CFrame * CFrame.new(2,20,2))
                           else   
...
spawn(function()
    while wait() do
        pcall(function()
            if _G.RelzFishBoat and World3 then
                if CheckPirateBoat() then
                    ...
                    repeat
                        wait()
                        spawn(TP2(v.Engine.CFrame * CFrame.new(0, -20, 0), 1))
                ...
                pcall(function()  
                    ...
                    for i,v in pairs(game:GetService("Workspace").SeaBeasts:GetChildren()) do
						if v:FindFirstChild("HumanoidRootPart") then
                            repeat wait()                
					        AutoHaki()
					        TP2(v.HumanoidRootPart.CFrame * CFrame.new(1,PosC,45))
					        EquipAllWeapon()  
					        game.Players.LocalPlayer.Character.Humanoid.Sit = false
                            AutoSkill = true
                            AimBotSkillPosition = v.HumanoidRootPart
                            Skillaimbot = true
                            until not _G.AutoSeaBest or not v:FindFirstChild("HumanoidRootPart") 
                            AutoSkill = false
                            Skillaimbot = false                            
                        end
                    end
...
local Toggle = Tabs.Sea:AddToggle("MyToggle", {Title = "Through Stone", Default = true })
    Toggle:OnChanged(function(Value)
        _G.Nocliprock = Value
